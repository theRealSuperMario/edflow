...
def make_staircase_var(step, start,
                       start_value,
                       step_size, stair_factor,
                       clip_min=0.0, clip_max = 1.0,
                       **kwargs):
    stair_case = stair_factor ** ((tf.cast(step, tf.float32)-start) // step_size) * start_value
...
if __name__ == '__main__':
    ...
    scheduled_variable = make_var(t, schedule_config["var_type"], schedule_config["options"])
